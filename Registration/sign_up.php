                    ...
                    <div class="group-1">
                        ...
                        <div class="group-box">
                            ...
                            <div class="text-group">
                                ...
                                <input id="barangay" name="barangay" class="box" type="text"
                                    placeholder="Enter Barangay">
                            </div>
                            <div class="text-group">
                                <label for="province">Province</label>
                                <input id="province" name="province" class="box" type="text"
                        ...
                        <div class="group-box">
                            ...
                            <div class="text-group">
                                ...
                                <input id="con1" name="con1" class="box" type="text" placeholder="09*********"
                                    pattern="^\d{11}$" title="Please enter a valid 11-digit number">
                            </div>
                            <div class="text-group">
                        ...
                        <div class="group-box">
                            ...
                            <div class="text-group">
                                ...
                                <select class="box" id="yrLVL" name="yrLVL">
                                    ...
                                    <option value="<?php echo $year . ' ' . $section; ?>" <?php echo
                                        (isset($user['yrLVL']) && $user['yrLVL']=="$year $section" ) ? 'selected' : '' ;
                                        ?>>
                    ...
                    <div class="group-1">
                        <div class="group-box">
                            ...
                            <div class="text-group">
                                ...
                                <input id="username" name="username" class="box" type="text"
                            ...
                            <div class="text-group">
                                ...
                                <div class="pass">
                                    <input id="password" name="password" class="box" type="password"
