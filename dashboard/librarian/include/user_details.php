...
if (isset($_GET['id'])) {
    ...
    $librariansInfoResult = mysqli_query($conn, "SELECT * FROM user_details WHERE IDno = '$id'");
...
<body class="bg-light">
    <div class="container mt-5">
        ...
        <p><strong>Welcome, <?php echo htmlspecialchars($_SESSION['librarian']['username']); ?>!</strong></p>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_assoc($librariansInfoResult)): ?>
                    <tr>
                        <td><?php echo htmlspecialchars($row['IDno']); ?></td>
