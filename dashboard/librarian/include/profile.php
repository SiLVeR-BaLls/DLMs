...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-8">
        ...
        <div class="bg-white p-8 rounded-xl shadow-xl flex items-center space-x-8">
            ...
            <div>
                ...
                <div class="mt-4 flex space-x-4">
                    <a href="../ID_card.php?id=<?php echo htmlspecialchars($_SESSION['librarian']['IDno']); ?>" class="px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700">View ID</a>
                    <a href="include/edit_user.php?id=<?php echo htmlspecialchars($_SESSION['librarian']['IDno']); ?>" class="px-6 py-3 bg-green-600 text-white rounded-md hover:bg-green-700">Edit Profile</a>
                </div>
            </div>
        </div>
        ...
        <div class="mt-12 space-y-8">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-800 border-b-2 border-gray-200 pb-2">librarian Information</h2>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-4">
                    <div>
