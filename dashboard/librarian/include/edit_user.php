...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update'])) {
    ...
    if (empty($message)) {
        ...
        if (empty($message)) {
            header("Location: ../librarian.php?message=success&id=" . urlencode($IDno));
            exit();
        }
    }
}
...
<body class="bg-gray-100">
    <div class="container mx-auto p-6">
        <a href="../librarian.php?title=<?php echo urlencode($user['IDno']); ?>" class="btn btn-primary text-white bg-blue-600 px-4 py-2 rounded hover:bg-blue-700">
            List
        </a>
