...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex justify-center items-center mb-4">
      <div class="flex space-x-2 w-full sm:w-1/2 lg:w-1/3 justify-center">
        <button id="studentFilter"
          class="px-1 py-2 border border-gray-300 rounded bg-blue-500 text-white">Student</button>
        <button id="librarianFilter" class="px-1 py-2 border border-gray-300 rounded bg-blue-500 text-white">librarian</button>
        <button id="professorFilter"
          class="px-1 py-2 border border-gray-300 rounded bg-blue-500 text-white">Professor</button>
        <button id="staffFilter" class="px-1 py-2 border border-gray-300 rounded bg-blue-500 text-white">Staff</button>
        <button id="clearFilter" class="px-1 py-2 border border-gray-300 rounded bg-gray-500 text-white">Clear
          Filter</button>
      </div>
    </div>
    ...
    <div class="flex justify-center items-center mt-4 space-x-2">
      ...
      <?php endif; ?>
      <span class="px-4 py-2 text-gray-700">Page
        <?php echo $page; ?> of
        <?php echo $totalPages; ?>
      </span>
  ...
  <script>
    ...
    document.getElementById('librarianFilter').addEventListener('click', () => filterByType('librarian'));
