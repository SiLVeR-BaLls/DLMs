  ...
  <main class="flex flex-grow">
    ...
    <div class="flex-grow">
      ...
      <div class="w-full h-auto mx-auto">
        <!-- This will take 100% of the container width and 80% of the viewport height -->

        <!-- Navbar -->
        <div class="w-full h-16 flex sticky top-0 justify-evenly gap-4 p-2 bg-blue-600">
          <!-- Full width navbar with centered buttons -->
