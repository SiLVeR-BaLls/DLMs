...
<div class="container mx-auto py-8">
    <?php if ($message): ?>
        <div class="p-4 mb-4 text-center rounded-lg <?php echo $message_type === 'error' ? 'bg-red-100 text-red-600' : 'bg-green-100 text-green-600'; ?>">
            <?php echo $message; ?>
        </div>
    <?php endif; ?>

    <a href="../index.php" class="inline-block mb-4 text-blue-500 hover:underline">&larr; Back</a>
    ...
    <?php if (isset($book)): ?>
        <div class="text-center mb-6">
            ...
            <?php endif; ?>
            <h2 class="text-3xl font-semibold mt-4"><?php echo htmlspecialchars($book['B_title']); ?></h2>
            <div class="flex justify-center gap-4 mt-4">
                <a href="include/edit_book.php?title=<?php echo urlencode($book['B_title']); ?>" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Edit</a>
                <a href="AddBookCopy.php?title=<?php echo urlencode($book['B_title']); ?>" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">Add Copy</a>
                <a href="BookList.php?title=<?php echo urlencode($book['B_title']); ?>" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">List</a>
            </div>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="bg-white p-6 rounded-lg shadow">
                <h3 class="font-semibold text-lg mb-2">General Information</h3>
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                <h3 class="font-semibold text-lg mb-2">Identifiers</h3>
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                <h3 class="font-semibold text-lg mb-2">Classification</h3>
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                <h3 class="font-semibold text-lg mb-2">Publication Details</h3>
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                <h3 class="font-semibold text-lg mb-2">Physical Details</h3>
        ...
        <div class="mt-8">
            <h3 class="font-semibold text-2xl mb-4">Additional Information</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-white p-6 rounded-lg shadow">
                    <h4 class="font-semibold text-lg mb-2">Co-authors</h4>
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    <h4 class="font-semibold text-lg mb-2">Series</h4>
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    <h4 class="font-semibold text-lg mb-2">Subjects</h4>
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    <h4 class="font-semibold text-lg mb-2">Alternate Titles</h4>
                    <?php if ($alternateTitlesResult->num_rows > 0): ?>
                        <ul class="list-disc list-inside">
                            <?php while ($row = $alternateTitlesResult->fetch_assoc()): ?>
                                <li><?php echo htmlspecialchars($row['UTitle']) . " - " . htmlspecialchars($row['VForm']); ?></li>
                            <?php endwhile; ?>
                        </ul>
                    <?php else: ?>
