  ...
  <div class="mb-6 px-4 flex justify-between items-center">
    ...
    <div class="flex flex-row gap-4 items-center">
      ...
      <input type="text" id="searchInput"
        ...
        placeholder="Enter search term..." style="width: 70%;">
    ...
    <div class="flex items-center">
      ...
      <select id="limit" name="limit" class="bg-gray-200 border border-gray-400 p-2 rounded"
    ...
    <table class="min-w-full table-auto">
      ...
      <tbody id="bookTableBody">
        ...
        <tr class="border-y border-solid cursor-pointer hover:bg-gray-200"
          ...
          <td class="px-4 py-2 coauthors">
            <?php echo htmlspecialchars($row['coauthors']); ?>
          </td>
  ...
  <div class="mt-6 flex justify-between items-center space-x-2">
    ...
    <div class="flex justify-center w-full space-x-2">
      ...
      <div class="flex justify-center items-center">
        <!-- First Page Button -->
        <button class="text-blue-600 px-4 py-2 bg-white border rounded-lg hover:bg-blue-600 hover:text-white" <?php echo
          ($page <=1) ? 'disabled' : '' ; ?>
          onclick="window.location.href='?page=1&limit=
          <?php echo $limit; ?>'">
          &laquo;
        </button>
        ...
        <button class="text-blue-600 px-4 py-2 bg-white border rounded-lg hover:bg-blue-600 hover:text-white" <?php echo
          ...
          <?php echo max($page - 1, 1); ?>&limit=
          <?php echo $limit; ?>'">
          &lt;
        </button>
        <!-- Current Page Number -->
        <span class="mx-4">Page
          <?php echo $page; ?> of
        ...
        <button class="text-blue-600 px-4 py-2 bg-white border rounded-lg hover:bg-blue-600 hover:text-white" <?php echo
          ...
          onclick="window.location.href='?page=
          <?php echo min($page + 1, $total_pages); ?>&limit=
          <?php echo $limit; ?>'">
          &gt;
        </button>
        <!-- Last Page Button -->
